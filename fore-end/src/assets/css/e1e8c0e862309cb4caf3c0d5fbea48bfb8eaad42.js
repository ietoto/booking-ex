...
!(function (e, t) {
  ...
  (C.fn = C.prototype =
      ...
      function () {
        ...
        for (
          ...
          if (null != (i = arguments[s]))
            for (r in i) {
              if (((e = a[r]), (n = i[r]), "__proto__" === r)) continue;
              if (a === n) continue;
              l && n && (C.isPlainObject(n) || (t = C.isArray(n)))
                ? (t
                    ? ((t = !1), (o = e && C.isArray(e) ? e : []))
                    : (o = e && C.isPlainObject(e) ? e : {}),
                  (a[r] = C.extend(l, o, n)))
                : void 0 !== n && (a[r] = n);
            }
        return a;
    ...
    C.extend({
      ...
      isPlainObject: function (e) {
        ...
        if (v.ownLast) for (t in e) return m.call(e, t);
        for (t in e);
    ...
    (function (n) {
      ...
      (v = ie.setDocument =
        function (e) {
          ...
          return (
            ...
            (a = []),
            (b = []),
            (h.qsa = G.test(u.querySelectorAll)) &&
              (se(function (e) {
        ...
        return (
          ...
          ae(function (e, t, n, r) {
            var i,
              ...
              d = g ? (v || (e ? p : l || m) ? [] : t) : f;
            if ((g && g(f, d, n, r), m))
              for (i = ye(d, u), m(i, [], n, r), o = i.length; o--; )
                (a = i[o]) && (d[u[o]] = !(f[u[o]] = a));
            if (e) {
              if (v || p) {
                if (v) {
      ...
      function xe(e) {
        for (
          ...
          if ((t = x.relative[e[s].type])) c = [me(ve(c), t)];
          else {
      ...
      return (
        ...
        (m = ie.select =
          function (e, t, n, r) {
            ...
            return (
              (l || f(e, c))(r, t, !y, n, (Z.test(e) && pe(t.parentNode)) || t),
              n
            );
          }),
  ...
  (C.Callbacks = function (i) {
    ...
    var r,
      ...
      f = function (e) {
        for (
          t = i.memory && e, o = !0, s = u || 0, u = 0, a = l.length, r = !0;
          l && s < a;
          s++
        )
    ...
    (C.ready.promise = function (e) {
      if (!A)
        if (((A = C.Deferred()), "complete" === N.readyState))
          setTimeout(C.ready);
  ...
  function R(e, t, n, r) {
    ...
    var i,
      ...
      l = s ? e[a] : e[a] && a;
    if (
      !((l && u[l] && (r || u[l].data)) || void 0 !== n || "string" != typeof t)
    )
      return;
    return (
      l || (l = s ? (e[a] = f.pop() || C.guid++) : a),
      u[l] || (u[l] = s ? {} : { toJSON: C.noop }),
      ("object" != typeof t && "function" != typeof t) ||
        (r ? (u[l] = C.extend(u[l], t)) : (u[l].data = C.extend(u[l].data, t))),
      (o = u[l]),
  ...
  (C.event = {
    ...
    trigger: function (e, t, n, r) {
      ...
      if (!r && !u.noBubble && !C.isWindow(n)) {
        for (
          s = u.delegateType || d, Y.test(s + d) || (a = a.parentNode);
          a;
          a = a.parentNode
        )
          f.push(a), (l = a);
      ...
      for (c = 0; (a = f[c++]) && !e.isPropagationStopped(); )
        (e.type = 1 < c ? s : u.bindType || d),
          (i = (C._data(a, "events") || {})[e.type] && C._data(a, "handle")) &&
            i.apply(a, t),
          (i = o && a[o]) &&
            i.apply &&
            C.acceptData(a) &&
            ((e.result = i.apply(a, t)), !1 === e.result && e.preventDefault());
      if (
        ((e.type = d),
        !r &&
  ...
  (he.optgroup = he.option),
    ...
    C.extend({
      clone: function (e, t, n) {
        ...
        return (
          0 < (r = me(o, "script")).length && we(r, !u && me(e, "script")),
          (r = s = i = null),
          o
        );
      },
      buildFragment: function (e, t, n, r) {
        for (
          var i, o, a, s, u, l, c, f = e.length, d = te(t), p = [], h = 0;
          h < f;
          h++
        )
          if ((o = e[h]) || 0 === o)
            if ("object" === C.type(o)) C.merge(p, o.nodeType ? [o] : o);
              ...
              if (
                ...
                for (
                  ...
                  C.nodeName((l = o.childNodes[i]), "tbody") &&
                    !l.childNodes.length &&
                    o.removeChild(l);
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || C.cleanData(me(n)),
            n.parentNode &&
              (t && C.contains(n.ownerDocument, n) && we(me(n, "script")),
      ...
      domManip: function (n, r) {
        ...
        if (
          ...
          for (i = (o = C.map(me(s, "script"), be)).length; u < l; u++)
            (t = s),
              u !== f &&
                ((t = C.clone(t, !0, !0)), i && C.merge(o, me(t, "script"))),
              r.call(this[u], t, u);
          if (i)
            for (
              a = o[o.length - 1].ownerDocument, C.map(o, xe), u = 0;
              u < i;
              u++
            )
              (t = o[u]),
  ...
  v.shrinkWrapBlocks = function () {
    ...
    var e, t, n;
    if (((Ee = !1), !(t = N.getElementsByTagName("body")[0]) || !t.style))
      return;
    return (
  ...
  function Ue(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]), He.test(i))
      )
        return i;
  ...
  C.extend({
    ...
    style: function (e, t, n, r) {
      ...
      var i,
        ...
        u = e.style;
      if (
        ((t = C.cssProps[s] || (C.cssProps[s] = ze(u, s))),
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = C.camelCase(t);
      if (
        ((t = C.cssProps[s] || (C.cssProps[s] = ze(e.style, s))),
        (a = C.cssHooks[t] || C.cssHooks[s]) &&
          "get" in a &&
          (o = a.get(e, !0, n)),
        void 0 === o && (o = De(e, t, r)),
        ...
        return (i = parseFloat(o)), !0 === n || C.isNumeric(i) ? i || 0 : o;
      return o;
    },
  }),
    C.each(["height", "width"], function (e, i) {
      C.cssHooks[i] = {
        get: function (e, t, n) {
          if (t)
            return Fe.test(C.css(e, "display")) && 0 === e.offsetWidth
              ? C.swap(e, Re, function () {
                  return Ue(e, i, n);
                })
              : Ue(e, i, n);
        },
    ...
    ot = [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          (l = C.css(t, "display")),
          "inline" ===
            ("none" === l ? C._data(t, "olddisplay") || je(t.nodeName) : l) &&
            "none" === C.css(t, "float") &&
  ...
  (C.Animation = C.extend(ct, {
    ...
    (tt = (Ze = N.createElement("select")).appendChild(
      ...
      if (!arguments.length) {
        if (t) {
          if (
            ...
            return e;
          return "string" == typeof (e = t.value)
            ? e.replace(ft, "")
            : null == e
            ? ""
            : e;
  ...
  C.fn.extend({
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? C.removeAttr(e, n)
            : (vt && mt) || !gt.test(n)
            ? e.setAttribute((!mt && C.propFix[n]) || n, n)
    ...
    (vt && mt) ||
      (C.attrHooks.value = {
        set: function (e, t, n) {
          if (!C.nodeName(e, "input")) return dt && dt.set(e, t, n);
          e.defaultValue = t;
        },
      }),
    mt ||
  ...
  C.fn.extend({
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
        if (
          1 === this[n].nodeType &&
          0 <= (" " + this[n].className + " ").replace(xt, " ").indexOf(t)
        )
          return !0;
      return !1;
    },
      ...
      return (
        ...
        C.each(t[e] || [], function (e, t) {
          ...
          if ("string" == typeof n && !u && !s[n])
            return i.dataTypes.unshift(n), l(n), !1;
          if (u) return !(r = n);
        }),
        r
      );
  ...
  (Nt = Lt.exec(Et.toLowerCase()) || []),
    C.extend({
      ...
      ajax: function (e, t) {
        ...
        g.hasContent ||
          (g.data &&
            ((c = g.url += (Tt.test(c) ? "&" : "?") + g.data), delete g.data),
          !1 === g.cache &&
            (g.url = St.test(c)
              ? c.replace(St, "$1_=" + wt++)
              : c + (Tt.test(c) ? "&" : "?") + "_=" + wt++)),
  ...
  (C.offset = {
    setOffset: function (e, t, n) {
      ...
      "static" === l && (e.style.position = "relative"),
        ...
        (o = C.css(e, "top")),
        (u = C.css(e, "left")),
        ("absolute" === l || "fixed" === l) && -1 < C.inArray("auto", [o, u])
      ...
      offset: function (t) {
        ...
        return (
          ...
          (n = Kt(o)),
          {
            ...
            left:
              r.left + (n.pageXOffset || e.scrollLeft) - (e.clientLeft || 0),
          }
        );
      },
      position: function () {
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = qe(v.pixelPosition, function (e, t) {
        if (t)
          return (t = De(e, n)), He.test(t) ? C(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (C.noConflict = function (e) {
      return h.$ === C && (h.$ = en), e && h.jQuery === C && (h.jQuery = Zt), C;
    }),
  ...
  (function (l, n, a) {
    try {
      ...
      function c(e) {
        var t = n.console;
        r[e] ||
          ((r[e] = !n.enableRemoveMigrateWarns),
          l.migrateWarnings.push(e),
          t &&
            t.error &&
            !l.migrateMute &&
            (t.error(e), l.migrateTrace && t.trace && t.trace()));
      }
      function e(e, t, n, r) {
      ...
      var s = l("<input/>", { size: 1 }).attr("size") && l.attrFn,
        u = l.attr,
        i =
      ...
      (l.fn.init = function (e, t, n) {
        ...
        l.browser ||
          ((t = l.uaMatch(navigator.userAgent)),
          (g = {}),
          t.browser && ((g[t.browser] = !0), (g.version = t.version)),
        ...
        (l.sub = function () {
          ...
          l.extend(!0, n, this),
            ...
            (n.fn.init = function (e, t) {
              return (
                t && t instanceof l && !(t instanceof n) && (t = n(t)),
      ...
      l.fn.data = function (e) {
        ...
        if (
          ...
          return c("Use of jQuery.fn.data('events') is deprecated"), n;
        ...
        (l.clean = function (e, t, n, r) {
          ...
          if ((l.merge(u, l.buildFragment(e, t).childNodes), n))
            for (
              ...
              (l.nodeName(o, "script") && a(o)) ||
                (n.appendChild(o),
                void 0 !== o.getElementsByTagName &&
                  ((s = l.grep(
                    l.merge([], o.getElementsByTagName("script")),
                    a
                  )),
      ...
      l.event.props &&
        ...
        (l.fn.error = function () {
          ...
          if (
            (c("jQuery.fn.error() is deprecated"),
            e.splice(0, 0, "error"),
            arguments.length)
          )
        ...
        (l.fn.toggle = function (n, e) {
          ...
          var r = arguments,
            ...
            o = function (e) {
              ...
              return (
                l._data(this, "lastToggle" + n.guid, t + 1),
                e.preventDefault(),
        ...
        (l.fn.live = function (e, t, n) {
          if (
            (c(
              'jQuery.fn.live() is deprecated. Use "$(document).on( types, selector, data, fn );" instead.'
            ),
            E)
          )
        ...
        (l.fn.die = function (e, t) {
          if (
            (c(
              'jQuery.fn.die() is deprecated. Use "$(document).off( types, selector || "**", fn );" instead.'
            ),
            k)
          )
        ...
        (l.event.trigger = function (e, t, n, r) {
          return (
            n ||
              j.test(e) ||
              c("Global events are undocumented and deprecated"),
  ...
  Object.defineProperties &&
    (function (i, r) {
      ...
      r.each(
        r.event.keyHooks.props.concat(r.event.mouseHooks.props, r.event.props),
        function (e, i) {
          "target" !== i &&
            Object.defineProperty(r.Event.prototype, i, {
              get: function () {
                var e,
                  t,
                  n,
                  r = this.originalEvent && this.originalEvent[i];
                return void 0 !== this["_" + i]
                  ? this["_" + i]
                  : ((e = this),
                    void 0 !==
                      (n =
                        o[(t = i)] && void 0 === r
                          ? o[i].call(this, this.originalEvent)
                          : r) && Object.defineProperty(e, t, { value: n }),
                    n);
              },
              set: function (e) {
                this["_" + i] = e;
