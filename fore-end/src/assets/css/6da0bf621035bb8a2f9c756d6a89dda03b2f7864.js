booking.env.enable_scripts_tracking &&
  (booking.env.scripts_tracking.core_deps = { loaded: !0, run: !1 }),
  (function () {
    /**
    ...
    !(function (h) {
      ...
      function w(e, t) {
        var n,
          r = B.env && B.env.b_dev_server,
          i =
            (n = B.reportError) &&
            "[object Function]" === {}.toString.call(n) &&
            B.reportError.bind(B);
        ...
        if ((p || v) && d) {
          for (f = (n = e.split("/")).length; 0 < f; f -= 1) {
            if (((r = n.slice(0, f).join("/")), p))
              for (l = p.length; 0 < l; l -= 1)
                if ((i = d[p.slice(0, l).join("/")]) && (i = i[r])) {
                  (o = i), (u = f);
                  break;
                }
            if (o) break;
          ...
          if (((r = r || e), "undefined" === l || "function" === l)) {
            for (
              ...
              "require" === (o = (u = p(t[s], r)).f)
                ...
                ? (f[s] = k(o))
                : u.p
                ? (u.p.load(u.n, T(r, !0), E(o), {}), (f[s] = v[o]))
                : w(e + " missing " + o, "almond");
            (a = n ? n.apply(v[e], f) : void 0),
              e &&
                (i && i.exports !== h && i.exports !== v[e]
                  ? (v[e] = i.exports)
                  : (a === h && c) || (v[e] = a));
          } else e && (v[e] = n);
        }),
  ...
  "function" != typeof Object.values &&
    (Object.values = function (e) {
      var t = [];
      for (var n in e)
        e.hasOwnProperty(n) && e.propertyIsEnumerable(n) && t.push(e[n]);
      return t;
    }),
  booking.env.enable_scripts_tracking &&
    (booking.env.scripts_tracking.bhc = { loaded: !0, run: !1 }),
  (function (n, r) {
    "use strict";
    if (r.jstmpl) return;
    var i,
    ...
    (o = function (e, t) {
      ...
      (s = function (e, t, n) {
        ...
        return (
          x(
            "Attempting to use non-numeric value '" +
              e +
              "' for translation tag '" +
              n +
              "'"
      ...
      (x = function (e, t) {
        (e = e || "BHCJS runtime issue"),
          r && r.env && r.env.b_dev_server
            ? (t && console.warn("Template: " + t), console.error(e))
            : i.error_out &&
              n.onerror &&
              n.onerror("JSTMPL:: " + e, t || "jstmpl", 0);
      }),
      (c = function (e) {
      ...
      (h = function (e, t, n) {
        ...
        for (t.length; ; ) {
          ...
          a === o
            ? (f(e, t.substring(i + 1, o), n + 1), (r = o + 1))
            : (e.push(t.substring(i, a)), (r = a));
        }
      }),
      (f = function (e, t, n) {
        if (0 < n) {
          if (42 <= n)
            return (
              console.warn(
                "Detected excessive recursion in tag sequence: %s, returning '%s'",
                interpolate_tags.slice(1, 42).join(" "),
                value
              ),
              void e.push(t)
            );
          if (t === p[n - 1])
            return (
              console.warn(
                "Detected self-referential tag '%s', returning '%s'",
                value,
                value
              ),
              void e.push(t)
        ...
        for (var r = 0, i = a.length; r < i; ++r)
          if (t in a[r]) {
            var o = a[r][t];
            return void ("string" == typeof o && -1 !== o.indexOf("{")
              ? h(e, o, n + 1)
              : e.push(o));
          }
        if (u && t in u)
          return void ("string" == typeof (o = u[t]) && -1 !== o.indexOf("{")
            ? h(e, o, n + 1)
            : e.push(o));
        e.push("");
      }),
      (T = function (e) {
        for (var t = e.split(/\s/), n = 0, r = t.length; n < r; ++n)
          t[n] = b(t[n]);
        return t.join(" ");
      }),
      (E = {}),
      (o.prototype = {
        ...
        fn: {
          ...
          GET_TRANS: (v = function (e, t, n, r) {
            x("to use TMPL_TRANS/TMPL_TRANSLIST, pass 'get_trans' to setup()");
          }),
          SET_VAR: (_ = function (e, t) {
            a[a.length - 2][e] = t;
          }),
          GET_TEXT: (t = function (e, t, n) {
            x("to use TMPL_TEXT, pass 'get_text' to setup()");
          }),
          ...
          STATIC_HOSTNAME: function (e, t, n, r) {
            x(
              "to use TMPL_STATIC_URL/TMPL_SCRIPT_URL, pass 'get_static_hostname' to setup()"
            );
          },
          ...
          VP: function (e, t) {
            x(
              "to use TMPL_VAR, with N attribute, pass 'get_var_plural' to setup()"
            );
          },
          SV: function (e) {
            return (a = e);
          ...
          seq: function (e, t, n) {
            ...
            if (
              ...
              (t = t || 0),
              (n = Math.abs(n || 1)),
              "string" != typeof e || isNaN(e) || (e = Number(e)),
              "string" != typeof t || isNaN(t) || (t = Number(t)),
              /^[A-Za-z]$/.exec(e) || /^[A-Za-z]$/.exec(t))
            )
              if (
                ((1 !== e.length ||
                  1 !== t.length ||
                  (/[a-z]/.exec(e) && !/[a-z]/.exec(t)) ||
                  (/[A-Z]/.exec(e) && !/[A-Z]/.exec(t))) &&
                  x("Invalid range '" + e + "'-'" + t + "' in seq()"),
                (e = e.charCodeAt(0)) <= (t = t.charCodeAt(0)))
              )
                for (; e <= t; )
                  r.push({ value: String.fromCharCode(e) }), (e += n);
              else
                for (; t <= e; )
                  r.push({ value: String.fromCharCode(e) }), (e -= n);
            else if (e <= t) for (; e <= t; ) r.push({ value: e }), (e += n);
            else for (; t <= e; ) r.push({ value: e }), (e -= n);
            return r;
          },
          defined: function (e) {
            return void 0 !== e ? 1 : 0;
          ...
          sprintf: function () {
            for (
              var e, t = [].slice.apply(arguments), n = t.splice(0, 1)[0];
              (e = t.splice(0, 1)[0]);
      ...
      ((i = function (e, t) {
        ...
        t(o.prototype.fn, e.fn),
          t(o.prototype.fn.FILTERS, e.filters),
          "get_trans" in e &&
            (o.prototype.fn.GET_TRANS = o.prototype.fn.ME = e.get_trans),
          "get_text" in e &&
            (o.prototype.fn.GET_TEXT = o.prototype.fn.MF = e.get_text),
          "get_var_plural" in e &&
            (o.prototype.fn.GET_VAR_PLURAL = o.prototype.fn.VP =
              e.get_var_plural),
          "get_static_hostname" in e &&
            (o.prototype.fn.STATIC_HOSTNAME = e.get_static_hostname),
          "get_csrf_token" in e &&
            (o.prototype.fn.CSRF_TOKEN = e.get_csrf_token),
          "get_date" in e && (o.prototype.fn.DATE = e.get_date),
          "get_helper" in e && (o.prototype.fn.HELPER = e.get_helper),
          "translations" in e && (u = e.translations);
      }),
      (i.fn = o.prototype.fn),
      i("__no_op__", function () {
        return x("JSTMPL -> TMPL not found") || "";
      }),
      (r.jstmpl = i);
  ...
  (function () {
    ...
    (e = function () {
      ...
      booking.jstmpl.setup({ get_csrf_token: e });
  })(),
  (function (i) {
    if (
      ((i.jstmpl = i.jstmpl || {
        setup: function () {
          console.error(
            "This is a mocked method. It's needed for client BHC templates to work, and doesn't need to work while we don't use them"
          );
        },
      }),
      i.jstmpl.translations)
    )
      return;
    var o,
      r = i.jstmpl,
      ...
      a = function (e, t, n, r) {
        ...
        if (o) {
          if (/^[0-9]+$/.test(r)) i = parseInt(r, 10);
            ...
            /^[0-9]+$/.test(a)
              ? (i = a)
              : console.warn(
                  "Trying to use a non-numeric template var for exception tool on copy '%s'",
                  e
                );
          }
          n("num", i);
        ...
        if (s && s.global_translation_tags)
          for (var u in s.global_translation_tags)
            t(u) || n(u, s.global_translation_tags[u]);
        return p(e, t, n, i, o);
      },
      p = function (e, t, n, r, i) {
        var o,
          a = e.split("/");
        ("" === a[0] && a.shift(), 1 == a.length) &&
          ("{" === (c = a[0]).charAt(0) &&
            "}" === c.charAt(c.length - 1) &&
        ...
        if (((o = d(a[0], a[1], a[2])), i && (o = v(a, r) || o), o)) {
          var f = o.match(/{.*?}/g);
          if (!f) return o;
          for (u = 0, s = f.length; u < s; ++u) {
            ...
            (l =
              -1 === h.indexOf("/")
                ? t(h.substr(1, h.length - 2))
                : p(h.substr(1, h.length - 2), t, n, r, i)),
              (o = o.split(h).join(l));
          }
        }
        return o || "";
        ...
        if ("private" === e) {
          ...
          return (
            r &&
              ...
              r.experiment_hash &&
              r.value &&
              (i.et && i.et.stage(r.experiment_hash, 1),
              i.et && i.et.stage(r.experiment_hash, 2),
              (r = r.value)),
            r
          );
        }
    ...
    r.setup({ get_trans: a, get_var_plural: e, get_text: e });
    (r.translations = function (e, t, n) {
      ...
      (r.translations.set = function (e) {
        return e && ((o = e), r.setup({ translations: e.private || {} })), o;
      });
  })(window.booking || {}),
  (function () {
  ...
  (function (t) {
    ...
    (r = function (e) {
      ...
      (n = function (e) {
        return String(e)
          .replace(/&(?!amp;|lt;|gt;|quot;|#39;|#47;)/g, "&amp;")
          .replace(/[<>"'\/]/g, r);
      }),
      (o = function (e, t) {
        return "\n<br />" + (t ? "\n<br />" : "");
      ...
      (b = function (e) {
        return e in k ? k[e] : "&#" + e.charCodeAt(0) + ";";
      }),
      (g = function (e) {
        return String(e).replace(
          /[\u0000-\u0008\u000b\u000c\u000e-\u001f&<>"'\/\u00A0-\u9999<>]/g,
  ...
  (function (s) {
    ...
    (c = function (e) {
      ...
      (e = function (e, t, n, r) {
        ...
        if (e && !/https?:/.test(e.toString()))
          if (
            s &&
            s.env &&
            s.env.static_hostnames &&
            s.env.static_hostnames.length
          )
            if (1 === s.env.static_hostnames.length)
              i = s.env.static_hostnames[0];
            else {
              var a = c(e.toString()),
      ...
      (t = function (e, t, n, r, i) {
        ...
        -1 != e.indexOf("T") &&
          3 == e.split(":").length &&
          (e = e.substr(0, e.lastIndexOf(":")).replace("T", " "));
        ...
        return o(
          ...
          { begin_marker: n, end_marker: r }
        );
      }),
      (o = function (e) {
        return s.jstmpl.fn && s.jstmpl.fn.FILTERS && s.jstmpl.fn.FILTERS.html
          ? s.jstmpl.fn.FILTERS.html(e)
          : "";
      }),
      (a = function (e) {
        return s.jstmpl.fn &&
          s.jstmpl.fn.FILTERS &&
          s.jstmpl.fn.FILTERS.entities
          ? s.jstmpl.fn.FILTERS.entities(e)
          : "";
      }),
      (r = function (e, t, n) {
      ...
      (u = function (e, n) {
        ...
        if (!e || !n || !u) return "";
        if (((i = "bk-icon -" + a + (i ? " " + i : "")), "IMG" === u.tagName))
          return '<img src="' + u.src + '" class="' + i + ' -fallback" />';
        o &&
          (t = r =
            {
              largest: 32,
        ...
        if (!d && void 0 !== typeof XMLSerializer) {
          ...
          d = "";
          for (var _ = u.childNodes, m = 0; m < _.length; m++)
            d += v.serializeToString(_[m]);
        }
        return "<svg " + p + ">" + d + "</svg>";
      }),
      (f = function (e, t, n, r) {
        try {
          return u(e, { width: t, height: n, class: r });
        } catch (e) {
  ...
  window.booking &&
    booking.define &&
    booking.jstmpl &&
    (booking.define("jstmpl", function () {
  ...
  booking.env.enable_scripts_tracking &&
    (booking.env.scripts_tracking.bhc.run = !0),
  (function (e, t) {
    e("tmpl_data", [], function () {
      ...
      function s(e, t, n) {
        void 0 === u[e]
          ...
          : (u.b_dev_server &&
              console.warn(
                "SERVER::Trying to override " + e + " with value: " + t
              ),
            n && (u[e] = t));
      }
      function e(e, t) {
    ...
    e("request_info", [], function () {
      ...
      function t() {
        ...
        (i = Object.keys(r).join(",")),
          (n || (n = document.getElementById("req_info"))) &&
            (n.innerHTML !== t &&
              ((e = n.innerHTML),
              (r = e.split(",").reduce(function (e, t) {
                return (e[t] = !0), e;
              }, r)),
              (i = Object.keys(r).join(","))),
            (n.innerHTML = i));
      ...
      return {
        populate: function (e) {
          o(e),
            "string" == typeof e
              ? (o(e), t())
              : e instanceof Array && (e.forEach(o), t());
        },
      };
    });
  })(B.define, B.require),
  (function () {
    ...
    B.define("et", function () {
      ...
      e("et_debug", [], function () {
        var t,
          r =
            B.env.b_dev_server && B.env.et_debug_level
              ? parseInt(B.env.et_debug_level, 10)
              : 0;
        function i() {
          try {
            if (!t) {
            ...
            return (
              r &&
                console.log(
                  "Error when trying to init et event emitter",
                  "error:",
                  e
                ),
              null
        ...
        return {
          ...
          events: {
            ...
            NOT_EXISTING_ELEMENT_WONT_ADD_LISTENER:
              "not_existing_element_wont_add_listener",
          ...
          report: function (t, n) {
            try {
              ...
              r &&
                console.log(
                  "Error when trying to report et event",
                  t,
                  n,
                  "error:",
                  e
  ...
  B.define("env", function (e, t, n) {
    ...
    if ((B.reportError({ message: r }, "benv"), B.env && B.env.b_dev_server))
      throw new Error(r);
    return B.env;
  }),
  ...
  B.define("formatting/date", function (e, a, t) {
    var f = B.env.b_date_format,
      ...
      h = B.env.b_weekday_formatted_date,
      p = B.require("utils/string-interpolate");
    function c(e) {
      return (e < 10 ? "0" : "") + e;
    }
    (h[0] = h[7]),
      (a.format = function (e, t) {
        if (!e || void 0 === e.year || void 0 === e.month || void 0 === e.day)
        ...
        if (
          ...
          (e.month = +e.month),
          (e.day = +e.day),
          isNaN(e.year) || isNaN(e.month) || isNaN(e.day))
        )
          throw new Error("formatting/date: invalid date provided");
        var n = f[t] || t,
          r = new Date(
            Date.UTC(e.year, e.month, e.day, e.hours || 0, e.minutes || 0)
          ),
          i = r.getUTCMonth() + 1,
          o = r.getUTCDate(),
          a = l[i],
      ...
      (a.compat = function (e, t) {
        ...
        if (e instanceof Date) n = e;
          ...
          (e && e.indexOf && -1 === e.indexOf(":") && (e += " 00:00"),
          (n = !isNaN(Date.parse(e)) && new Date(e)) ||
            null == e ||
            ((e = e.replace(/-/g, "/")),
            (n = !isNaN(Date.parse(e)) && new Date(e))),
          !n)
    ...
    (a.locale_format = function (e) {
      ...
      if (
        ...
        throw new Error("formatting/date: invalid date provided — " + t);
      if (
        o &&
        !(o = o.replace(d, function (e, t) {
          return t;
        })).match(d)
      )
        throw new Error("formatting/date: invalid date_until provided — " + o);
      ...
      return (
        [a].concat(o ? [u] : []).forEach(function (n, r) {
          var e = (r ? o : t).split(/-0*/),
            i = {
              ...
              weekday:
                h[
                  new Date(
                    Date.UTC(+e[0], +e[1] - 1, +e[2], 0, 0, 0, 0)
                  ).getUTCDay()
                ],
            };
          ["full_year", "month", "day_of_month"].forEach(function (e, t) {
            ...
            ["%", "%_nom", "%_in", "%_from", "%_to", "short_%"].forEach(
              function (t) {
                Object.keys(i).forEach(function (e) {
                  s[(t + (r ? "_until" : "")).replace("%", e)] =
                    i[e][
                      "%" === t[0] || "month_name" === e
                        ? t.replace("%", "name").replace(/_nom$/, "_only")
                        : "short"
                    ];
                });
              }
            ...
            r ||
              (s.month_name_with_year_only =
                l[parseInt(n[1], 10)].name_with_year_only);
        }),
        p(f[i], s)
      );
    }),
      ...
      (a.stringify = function (e) {
        return a.format(
          a.breakdown(e),
          "{full_year}-{zero_padded_month}-{zero_padded_day_of_month} {time}"
        );
      });
  }),
  B.define("formatting/time", function (e, t, n) {
    ...
    return {
      locale_format: function (e) {
        var t,
          n = {};
        if (!(e = "object" != typeof e ? { time: e } : e).time)
          throw new Error("formatting/time: no time provided");
        if (
          ((e.until = e.until || !1),
          (e.no_html = e.no_html || !0),
          e.time
          ...
          12 < Math.abs(n.hour - 12) || 30 < Math.abs(n.minutes - 30))
        )
          throw new Error("formatting/time: invalid time provided — " + e.time);
        return (
          (n.hour = n.hour % 24),
          (n.hour_24h_no0 = n.hour),
          (n.hour_24h = o(n.hour)),
          (n.hour_24h_show24_no0 = n.minutes || n.hour ? n.hour_24h_no0 : 24),
          (n.hour_24h_show24 = o(n.hour_24h_show24_no0)),
          (n.hour_24h_until24_no0 =
            n[e.until ? "hour_24h_show24_no0" : "hour_24h_no0"]),
          (n.hour_24h_until24 = o(n.hour_24h_until24_no0)),
          (n.hour_12h_no0 = n.hour % 12 || 12),
          (n.hour_12h = o(n.hour_12h_no0)),
          (n.minutes_no0 = n.minutes),
          (n.minutes = o(n.minutes_no0)),
          (n.AM_PM = r[(n.hour < 12 ? "AM" : "PM") + "_symbol"].name),
          (t = i(r.time.name, n).trim()),
          e.no_html ? t.replace(/\s/g, "&nbsp;") : t
        );
      },
    };
  }),
  B.define("event-emitter", function (e, t, r) {
    (function () {
      ...
      function a(e) {
        ...
        if (
          (e.debug && ((t.debug = !0), (t.last = { time: 0, eventCount: 0 })),
          e.strict && ((t.strict = !0), (t.strictKeys = e.events), !e.events))
        )
          throw new Error("No events defined for emitter " + t.name);
        e.async &&
      ...
      function h(e, t, n) {
        ...
        var i = new Error(
          t +
            "(): event '" +
            n +
            "' has not been registered for emitter " +
            r.name
        );
        throw ((i.emitter = e), i);
      }
      (a.prototype.addListener = function (e, t, n) {
        var r = this._events;
        if (null == e)
          throw new Error("addListener(name, fn, context): name cant be " + e);
        return (
          r.strict && h(this, "addListener", e),
          (r.events[e] || (r.events[e] = [])).push(
            n ? { fn: t, context: n } : t
          ),
          this
        );
        ...
        (a.prototype.once = function (t, n) {
          this._events.strict && h(this, "once", t);
          var r = this,
            i = !1;
        ...
        (a.prototype.removeListener = function (e, t) {
          (a = this._events).strict && h(this, "removeListener", e);
          var n = this._events.events[e];
          if ("*" === e)
            if (t)
              for (var r in a.events)
                a.events.hasOwnProperty(r) && this.removeListener(r, t);
            else a.events = {};
          else if (t && n) {
        ...
        (a.prototype.emit = function (e) {
          ...
          t.strict && h(this, "emit", e), t.debug && this.tick();
          var n = t.events[e];
          if (!n) return this;
          n = l.call(n, 0);
        ...
        (a.prototype.emitNext = function (e) {
          this._events.strict && h(this, "emitNext", e);
          var t,
            n,
            r,
            i =
        ...
        (a.prototype.tick = function () {
          ...
          e.count++,
            5e3 < t - n.time &&
              ((e.rate = Math.floor((e.count - n.count) / (t - n.time) / 1e3)),
              (e.last = { time: t, count: e.count }));
        }),
        (a.prototype.proxy = function (t, n) {
          var r = this;
          return function () {
            var e = l.call(arguments, 0);
            "function" == typeof n && (e = n.apply(null, e)),
              e.unshift(t),
              r.emit.apply(r, e);
          };
        }),
      ...
      ? (function (e) {
          ...
          function a(n) {
            ...
            t(function () {
              ...
              if (null === t)
                return void (r._state ? n.resolve : n.reject)(r._value);
              try {
                e = t(r._value);
              } catch (e) {
            ...
            try {
              ...
              if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof t)
                  return void f(n(t, e), n(i, this), n(u, this));
              }
          ...
          (o.prototype.catch = function (e) {
            ...
            (o.all = function () {
              var u = Array.prototype.slice.call(
                1 === arguments.length && r(arguments[0])
                  ? arguments[0]
                  : arguments
              );
  ...
  B.define("when/core", function (h, e, t) {
    var p = h("promise"),
      d = {};
    function n(e) {
      if ("object" != typeof e)
        throw new Error("B.when: expecting an object as argument");
      var n,
        r,
        i,
        o,
        ...
        t =
          ...
          Object.keys(n).map(function (e) {
            var t = d[e];
            if (!t || "function" != typeof t.handler)
              throw new Error("B.when: " + e + " is not a valid condition");
            !0 === t.defer
              ? o.push({ key: e, value: n[e] })
              : i.push(t.handler.call(null, n[e], r)),
              (r.conditions[e] = n[e]);
          }),
          { resolved: i, deferred: o }),
        l = p
          .all(t.resolved)
          .then(function (e) {
            ...
            if (
              !t.deferred
                .map(function (e) {
                  return d[e.key].handler.call(null, e.value, f);
                })
                .every(Boolean)
            )
              return s && s.call(f);
    ...
    (n.add = function (e, t) {
      if ("string" == typeof e) d[e] = { name: e, handler: t };
      else {
        var n = e;
        d[n.name] = n;
      }
  ...
  B.define("when/events-view", function (e, t, n) {
    ...
    function f(e) {
      var t = s.scrollTop(),
        ...
        i = n.offset(),
        o = e[3] || a;
      if (i && t + r > i.top + o && n.is(":visible"))
        return e[1].call(e[2], n), !1;
      return !0;
    }
    function l() {
      if (i) return;
      (i = !0),
        (u = u.filter(f)).length ||
          (s.off("scroll", l), s.off("resize", l), (c = !1)),
        setTimeout(function () {
          i = !1;
        }, r);
    }
    n.exports = function (e, t, n, r) {
      ...
      f((i = [o(e), t, n || this, r])) && u.push(i),
        !c && u.length && (s.on("scroll", l), s.on("resize", l), (c = !0));
    };
  }),
        ...
        return (
          ...
          new r(function (i) {
            a(o.selector).each(function () {
              ...
              e.bind("mouseenter.when-hover", n),
                e.bind("mouseleave.when-hover", r);
            });
          })
        );
      },
  ...
  B.define("when/stage", function (e, t, n) {
    ...
    n.exports = {
      name: "stage",
      handler: function (e, t) {
        if (!t.conditions.experiment)
          throw new Error(
            'when: "stage" must come after "experiment" condition'
          );
  ...
  B.define("when/language", function (e, t, n) {
    n.exports = {
      ...
      handler: function (e) {
        ...
        if (1 === t.length && "cjk" === t[0])
          return Boolean(B.env.b_lang_is_cjk);
  ...
  window.B && (B.when = B.require("when")),
  (window.jQuery.cookie = function (e, t, n) {
    if (void 0 === t) {
      var r = null;
    ...
    (n = n || {}),
      null === t && ((t = ""), ((n = $.extend({}, n)).expires = -1));
    var u,
      s = "";
    n.expires &&
      ("number" == typeof n.expires || n.expires.toUTCString) &&
      ("number" == typeof n.expires
        ? (u = new Date()).setTime(u.getTime() + 24 * n.expires * 60 * 60 * 1e3)
        : (u = n.expires),
  ...
  B.define("ga-events-tracker", function (t, e, n) {
      ...
      this.events[n].forEach(
        function (t) {
          o.all(
            ...
            function () {
              var e = null;
              "function" == typeof t.value && (e = t.value()),
                "number" == typeof t.value && (e = t.value),
                r.trackEvent(this.categoryName, n, t.label, e);
            }.bind(this)
          );
        }.bind(this)
      );
    ...
    function u(e) {
      if (!e.categoryName)
        throw Error("ga-events-tracker: you must define a categoryName");
      if (!e.eventsMap)
        throw Error("ga-events-tracker: you must define an eventsMap");
      (this.emitter = e.emitter || t("events")),
        (this.events = e.eventsMap),
        (this.categoryName = e.categoryName),
        Object.keys(this.events).forEach(i.bind(this));
    }
    var s = {
      setup: function (e) {
        return new u(e);
  ...
  booking.env.enable_scripts_tracking &&
    (booking.env.scripts_tracking.core_deps.run = !0);
