...
B.define("with-capla", function (_, i, e) {
  ...
  function d(i) {
    return (
      _i_("edd:dcecff49"),
      t[i] ||
        (t[i] = new n(function (_) {
          _i_("edd:e000dba4"), (r[i] = _), _r_();
        })),
      _r_({ promise: t[i], resolve: r[i] })
    );
  }
  window.B.__caplaInitialised &&
    Object.keys(window.B.__caplaInitialised).forEach(function (_) {
      _i_("edd:1d620442"),
        d(a(_)).resolve(window.B.__caplaInitialised[_]),
        _r_();
    }),
  ...
  B.define("component/genius-vip/const", function (_, i, e) {
    ...
    (e.exports = {
      ...
      MFE_EVENT: {
        ...
        CAPLA_EVENT_genius_vip_REMINDER_MODAL_CTA_CLICK:
          "reminderModalCtaClick",
  ...
  B.define("component/genius-vip/tracking", function (_, i, e) {
    ...
    var n = _("component"),
      ...
      o = function (_, i, e) {
        if (
          (_i_("edd:05ad6432"),
          !s.CAMPAIGN[_] || !s.MFE_EVENT[i] || !s.ACTION[e])
        )
          return _r_();
      ...
      r = n.extend({
        init: function () {
          if ((_i_("edd:37530ec1"), !+this.getAttr("data-tracking-enabled")))
            return _r_();
          var n = !1,
          ...
          function i(_) {
            ...
            n = !0;
            var i = _.eventBus;
            for (var e in s.MFE_EVENT)
              Object.prototype.hasOwnProperty.call(s.MFE_EVENT, e) &&
                (function (e) {
                  _i_("edd:93296bda"),
                    i.subscribe(e, function (_, i) {
                      if (
                        (_i_("edd:96bdd4c7"),
                        "search-web" === t &&
                          "searchresults" === r &&
                          "CAPLA_EVENT_genius_vip_BANNER_VIEW" === e)
                      ) {
                        if (a) return _r_();
                        a = !0;
                      }
          ...
          document.addEventListener("booking-capla-initialized", function (_) {
            _i_("edd:c878d6f6"), i({ eventBus: _.detail.eventBus }), _r_();
          }),
            d(t, r, i)(),
            _r_();
        },
